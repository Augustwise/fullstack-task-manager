      ...
      <main className="container">
        <section className="about-section">
          ...
          <p>
            ...
            academic deadlines, or professional projects, our application provides the features you need
            to stay on top of everything.
          </p>
          <p>
            Our goal is to offer a clean, intuitive, and efficient user experience, allowing you to focus
            on what truly matters: getting things done.
          </p>
        </section>
          ...
          <div className="features-grid">
            ...
            <div className="feature-item">
              ...
              <p>
                ...
                <span className="priority-low">Low</span>) to focus on what&apos;s most important.
              </p>
            </div>
            <div className="feature-item">
